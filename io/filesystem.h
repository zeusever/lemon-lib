 ...
 *			of lemon_char_tacters that are written to the buffer, not including the 
 *			terminating null lemon_char_tacter.If the function fails, the return 
 ...
 *			the buffer, in lemon_char_tacters, including the null-terminating lemon_char_tacter. 
 *			
 */
LEMON_IO_API 
	size_t		
